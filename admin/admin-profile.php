...
<!-- Content -->
<div class="col-xl-12 col-lg-8 col-md-6 col-sm-12 card layout-top-spacing">

    <div class="user-profile">
        <div class="">
            <div class="d-flex card-header justify-content-between">
                <h3 class="">Admin Profile</h3>
                <a href="edit_admin_profile.php" class="mt-2 edit-profile">Change Password</a>
            </div>
            <div class="text-center user-info">
                <h3 style="font-weight: bold;" class="">Jimmy Turner</h3>
            </div>
            <div class="card-body">
